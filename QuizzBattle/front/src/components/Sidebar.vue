<template>
  ...
  <aside id="default-sidebar" class="fixed top-0 left-0 z-40 w-64 h-screen transition-transform -translate-x-full sm:translate-x-0" aria-label="Sidebar">
    <div class="h-full px-8 overflow-y-auto bg-gray-50">
        <ul class="space-y-6 font-medium">
            ...
            <li>
                <router-link :to="{ name: 'admin_users' }" class="flex items-center p-2 text-gray-900 rounded-lg hover:bg-gray-100 group">
                    ...
                    <h2 class="flex-1 ml-3 text-gray-700 whitespace-nowrap">Users</h2>
                </router-link>
            </li>
            <li>
                <router-link :to="{ name: 'admin_surveys' }" class="flex items-center p-2 text-gray-900 rounded-lg hover:bg-gray-100 group">
                    <svg class="w-8 h-8 text-gray-500" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 18 18">
                    ...
                    <h2 class="flex-1 ml-3 text-gray-700 whitespace-nowrap">Surveys</h2>
                </router-link>
            </li>
            <li>
                <a href="#" class="flex items-center p-2 text-gray-900 rounded-lg hover:bg-gray-100 group">
                    <svg class="flex-shrink-0 w-8 h-8 text-gray-500 transition duration-75 group-hover:text-gray-900" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 18 16">
                        <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M1 8h11m0 0L8 4m4 4-4 4m4-11h3a2 2 0 0 1 2 2v10a2 2 0 0 1-2 2h-3"/>
                    </svg>
                    <h2 class="flex-1 ml-3 text-gray-700 whitespace-nowrap">Log out</h2>
                </a>
            </li>
        </ul>
    </div>
